    ...
    <div className="bg-[#5affe7]">
      <div className="mx-auto max-w-2xl py-20">
        <div className="text-center">
          <h1 className="text-balance text-5xl font-semibold tracking-tight text-[#5c57e9] sm:text-7xl">
            Share your story, inspire, and start blogging!
          </h1>
          <p className="mt-8 text-pretty text-lg font-medium text-[#726eff] sm:text-xl/8">
